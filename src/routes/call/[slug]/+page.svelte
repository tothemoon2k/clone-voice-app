<script>
    ...
    onMount(async () => {
        ...
        loading = false;
        //if true and true, make call and return call id
        //ever 2 seconds or so check the status of the call and update state accordingly
        //when call ends, make request to api for recording
    })
...
<div class="w-screen h-screen flex flex-col items-center justify-center gap-20">
    ...
    {:else if shouldRing === null || shouldRing === false}
        <div class="w-5/6 flex flex-col items-center">
            <img class="h-20" src={img}  alt="Person">
